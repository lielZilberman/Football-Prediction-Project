...
app = FastAPI()
origins = ["http://127.0.0.1:8000"]  # Add the origins you want to allow
...
def get_hello():
    ...
    def train(X_train, X_test, y_train, y_test):
        for clf in classifiers:
            ...
            # print(f"{clf._class.name_}: Accuracy = {accuracy:.4f}")
    ...
    def get_results(this_week):
        ...
        this_week.drop(["Result_svc"], axis=1, inplace=True)
        return this_week
